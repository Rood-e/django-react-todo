        ...
        <div className="grid h-screen place-items-center bg-white dark:bg-slate-950 px-6 py-24 sm:py-32 lg:px-8 text-center transition-colors duration-500">
            <div className="relative">
                ...
                <div className="relative z-10">
                    <p className="text-base font-bold text-blue-600 dark:text-blue-400 tracking-wide uppercase">404</p>
                    ...
                    <div className="mt-10 flex items-center justify-center gap-x-6">
                        <Link to="/" className="rounded-xl bg-blue-600 px-6 py-3 text-sm font-bold text-white shadow-lg
                            shadow-blue-500/25 hover:bg-blue-500 transition-all hover:scale-105 active:scale-95">
                            Torna alla Home
                        </Link>
                        <Link to="/legal/contact" className="text-sm font-semibold text-slate-900 dark:text-slate-300
